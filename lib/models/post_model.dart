...
class Post {
  ...
  @override
  String toString() {
    return 'Post(id: $id, communityName: $communityName, title: $title, link: $link, description: $description, communityProfilePic: $communityProfilePic, upvotes: $upvotes, downvotes: $downvotes, commentCount: $commentCount, username: $username, uid: $uid, type: $type, createdAt: $createdAt, awards: $awards)';
  }
